...
class TicTacToe:
    def __init__(self):
        # we will use a single liset to rep 3x3 board
    ...
    def winner(self, square, letter):
        ...
        # check the diagonals
        # but only if the sqare is an even number (0, 2, 4, 6, 8)
        ...
        # if all checks fail, then no winner
        return False
...
def play(game, x_player, o_player, print_game=True):
    ...
    while game.empty_squares():
        ...
        # tiny break make thins easier to read
        time.sleep(0.8)
